...
export const mockElectronAPI = {
  cancelProcessing: async () => {
    console.log('[Playground] cancelProcessing called')
  },
  isDebugMode: async () => true,
  getWindowWorkspace: async () => 'playground-workspace',
  getSetupNeeds: async () => ({
  ...
  getModel: async () => 'claude-sonnet-4-20250514',
  setModel: async () => {},
  ...
  getVersions: () => ({ node: '0.0.0', chrome: '0.0.0', electron: '0.0.0' }),
